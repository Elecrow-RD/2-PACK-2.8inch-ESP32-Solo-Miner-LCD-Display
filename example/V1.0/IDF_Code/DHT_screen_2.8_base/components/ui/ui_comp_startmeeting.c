...
lv_obj_t * ui_startMeeting_create(lv_obj_t * comp_parent)
{
    ...
    cui_startMeeting = lv_button_create(comp_parent);
    ...
    lv_obj_remove_flag(cui_startMeeting, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    lv_obj_t ** children = lv_malloc(sizeof(lv_obj_t *) * _UI_COMP_STARTMEETING_NUM);
